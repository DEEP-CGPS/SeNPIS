...
#Train AlexNet with Scene15, the use of the FIT class is optional, you can use your own .fit
...
fo=Fit(Net=net,trainloader=trainloader,testloader=testloader
                  ...
                  SaveDir="Default",Net_Name="Best-AlexNet-Scene15")
fo.DoTrain(Epoch=20)

net=torch.load("Default/Best-AlexNet-Scene15.pth")
...
torch.save(net,"Default/PrunedAlexNet-Scene15-P.pth")

#The pruned network is retrained "P+FT"
optimizer = optim.SGD(net.parameters(), lr=0.001, momentum=0.9)
fo=Fit(Net=net,trainloader=trainloader,testloader=testloader
                  ,valloader=testloader,device=device,NV=3,
                  criterion=criterion,optimizer=optimizer,Net_Name="PrunedAlexNet-Scene15-P+FT")
fo.DoTrain(Epoch=10)
